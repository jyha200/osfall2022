...
Start from the original [master branch kernel source](https://github.com/jyha200/tizen-5.0-rpi3/) (you may already have it in your team repository's _master_ branch) and make incremental changes to get things done.
